...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.wzlSubmissions.setDragDropMode(QtWidgets.QAbstractItemView.InternalMove)
        self.wzlSubmissions.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
