...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.wzlFolders = QtWidgets.QTreeWidget(self.groupBox_13)
        ...
        self.groupBox_14 = QtWidgets.QGroupBox(self.folderPage_2)
        self.groupBox_14.setMinimumSize(QtCore.QSize(150, 0))
        ...
        self.folderTitle = QtWidgets.QLabel(self.groupBox_14)
        self.folderTitle.setText("")
        self.folderTitle.setObjectName("folderTitle")
        self.formLayout_7.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.folderTitle)
        ...
        self.submissionThumbnail = QtWidgets.QGraphicsView(self.groupBox_17)
        self.submissionThumbnail.setMaximumSize(QtCore.QSize(200, 200))
        self.submissionThumbnail.setObjectName("submissionThumbnail")
        self.verticalLayout_18.addWidget(self.submissionThumbnail)
        ...
        self.spinBox_2 = QtWidgets.QSpinBox(self.groupBox_18)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_14.setTitle(_translate("MainWindow", "Folder Info"))
